...
#else
#define MAIN_ROUTE_START_DELAY_USEC 100000
#endif
#endif
...
#else
#define MAIN_ROUTE_POLL_USEC 10000
#endif
#endif
...
#else
#define PIPE_PREPARE_POLL_USEC 10000
#endif
#endif
#ifndef ROOT_CHILD_WAIT_LOOPS
#define ROOT_CHILD_WAIT_LOOPS 5000
#endif
#ifndef ROOT_CHILD_POLL_USEC
#ifdef FAST_MODE
#define ROOT_CHILD_POLL_USEC 500
#else
#define ROOT_CHILD_POLL_USEC 1000
#endif
#endif
...
struct root_report {
  ...
  int ksud_late_load_ret;
  int ksud_late_load_errno;
  pid_t ksud_launcher_pid;
};
